...
With little bit of exposure to python, visual basic, and java, the syntax od R are somewhat similar. I affirm myself, R would be the choice to do the my data analysis even though I'm not expert on it. 
